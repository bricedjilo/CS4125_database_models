...
import com.finalproject.domain.OrderResp;
import com.finalproject.services.OrderNotFoundException;
...
public class OrderController {
    ...
    static {
        orders.add(new Order(1,"OrderNo1",100.12));
        orders.add(new Order(2,"Order No2",200.22));
    }
